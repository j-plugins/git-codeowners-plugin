...
class CodeownersHighlightUsagesHandlerFactory : HighlightUsagesHandlerFactoryBase() {
    override fun createHighlightUsagesHandler(
        ...
        file: PsiFile,
        target: PsiElement
    ): HighlightUsagesHandlerBase<CodeownersElementImpl>? {
        val file = file as? CodeownersFile ?: return null

        return object : HighlightUsagesHandlerBase<CodeownersElementImpl>(editor, file) {
