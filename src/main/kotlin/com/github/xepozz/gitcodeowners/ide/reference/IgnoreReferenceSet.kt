...
//import com.github.xepozz.gitcodeowners.ide.utils.Glob
//import com.github.xepozz.gitcodeowners.ide.utils.MatcherUtil
//import com.github.xepozz.gitcodeowners.ide.utils.Utils
...
//
//class IgnoreReferenceSet(element: GitCodeownersPattern) : FileReferenceSet(element) {
//
...
//            val containingFile = containingFile as? GitCodeownersFile ?: return
...
//                val entry = fileReferenceSet.element as GitCodeownersPattern
//                val current = canonicalText
//                val pattern = Glob.createPattern(current, entry.text) ?: return
...
//                    } else if (current.endsWith("*") && current != entry.text) {
