...
public class GitCodeownersPatternImpl extends ASTWrapperPsiElement implements GitCodeownersPattern {

  public GitCodeownersPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
