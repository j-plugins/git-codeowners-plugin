...
class CodeownersLexer implements FlexLexer {
   ...
   */
  CodeownersLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 7: break;
          case 3:
            { yybegin(YYINITIAL); return CodeownersTypes.EOL;
            }
          // fall through
          case 8: break;
          case 4:
          ...
          case 9: break;
          case 5:
            { return CodeownersTypes.COMMENT;
            }
          // fall through
          case 10: break;
          default:
