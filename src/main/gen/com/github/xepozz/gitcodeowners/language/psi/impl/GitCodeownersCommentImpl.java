...
public class GitCodeownersCommentImpl extends ASTWrapperPsiElement implements GitCodeownersComment {

  public GitCodeownersCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
