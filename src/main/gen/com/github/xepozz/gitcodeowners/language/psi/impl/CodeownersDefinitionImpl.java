...
public class CodeownersDefinitionImpl extends ASTWrapperPsiElement implements CodeownersDefinition {

  public CodeownersDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
